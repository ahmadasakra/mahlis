...
const translations: Record<Locale, Record<string, string>> = {
  ...
  ar: {
    ...
    'author.bio': 'متخصصة في الإعلام المقارن وتحليل الخطاب الإعلامي، مع اهتمام بدراسة السرديات والتأطير الإعلامي للنزاعات، خصوصاً تغطية الصراع الفلسطيني في المنصات الألمانية والدولية.',
    ...
    'about.intro': 'متخصصة في الإعلام المقارن وتحليل الخطاب الإعلامي، مع اهتمام بدراسة السرديات والتأطير الإعلامي للنزاعات، خصوصاً تغطية الصراع الفلسطيني في المنصات الألمانية والدولية.',
    ...
    'about.focus.description': 'كباحثة في مجال الإعلام والاتصال، تركز على الصحافة المرئية والإعلام المقارن وتحليل الخطاب الإعلامي، مع اهتمام بدراسة السرديات والتأطير الإعلامي للنزاعات، خصوصاً تغطية الصراع الفلسطيني في المنصات الألمانية والدولية..',
